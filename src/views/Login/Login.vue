      ...
      <div class="relative flex mx-auto min-h-100vh">
        ...
        >
          <div class="flex items-center relative text-white">
            ...
            <span class="text-20px font-bold">ElementAdmin</span>
          </div>
          <div class="flex justify-center items-center h-[calc(100%-60px)]">
            ...
            >
              ...
              <div class="text-3xl text-white" key="2">Welcome to the system</div>
              <div class="mt-5 font-normal text-white text-14px" key="3">Backstage management system</div>
            </TransitionGroup>
          </div>
        </div>
