<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 text-left">
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4 md:space-y-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">비밀번호를 잊으셨나요?</a>
            </div>
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">계정이 아직 없으신가요? <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">회원가입</a></p>
          </form>
          {{ form }}
        </div>
      </div>
